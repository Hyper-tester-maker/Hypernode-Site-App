...
const topNodes = [
  { id: 'Node-a4b8', country: 'Austria', type: 'GPU', load: 25, uptime: '99.9%', points: 125.12, activeSince: '2025-10-23', lat: 47.5162, lon: 14.5501 },
  { id: 'Node-c2d6', country: 'Austria', type: 'GPU', load: 45, uptime: '99.9%', points: 123.45, activeSince: '2025-10-23', lat: 48.2082, lon: 16.3738 },
  { id: 'Node-f8e1', country: 'Austria', type: 'CPU', load: 60, uptime: '98.5%', points: 84.66, activeSince: '2025-10-24', lat: 47.2692, lon: 11.4041 },
  { id: 'Node-g5h9', country: 'Austria', type: 'GPU', load: 85, uptime: '97.2%', points: 80.01, activeSince: '2025-10-24', lat: 46.6247, lon: 14.3053 },
  { id: 'Node-k3m4', country: 'Brazil', type: 'GPU', load: 30, uptime: '99.7%', points: 49.87, activeSince: '2025-10-25', lat: -14.2350, lon: -51.9253 },
  { id: 'Node-p9q2', country: 'United States', type: 'GPU', load: 40, uptime: '96.4%', points: 38.43, activeSince: '2025-10-26', lat: 39.8283, lon: -98.5795 },
  { id: 'Node-r5t7', country: 'New Zealand', type: 'GPU', load: 20, uptime: '100%', points: 17.29, activeSince: '2025-10-27', lat: -41.2865, lon: 174.7762 },
  { id: 'Node-s1v3', country: 'Canada', type: 'GPU', load: 15, uptime: '95.1%', points: 16.88, activeSince: '2025-10-27', lat: 56.1304, lon: -106.3468 },
  { id: 'Node-t2w4', country: 'Portugal', type: 'CPU', load: 10, uptime: '100%', points: 6.95, activeSince: '2025-10-28', lat: 39.3999, lon: -8.2245 },
  { id: 'Node-x5y1', country: 'Hong Kong', type: 'GPU', load: 5, uptime: '100%', points: 3.15, activeSince: '2025-10-28', lat: 22.3193, lon: 114.1694 },
  { id: 'Node-z1a2', country: 'Brazil', type: 'GPU', load: 8, uptime: '100%', points: 2.74, activeSince: '2025-10-29', lat: -23.5505, lon: -46.6333 },
];
...
const NetworkDashboard = () => {
  ...
  useEffect(() => {
    const randomMemory = (Math.random() * (85 - 80) + 80).toFixed(1);
