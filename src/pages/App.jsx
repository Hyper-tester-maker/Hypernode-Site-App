    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-full bg-black/80 border-cyan-500/50 text-white backdrop-blur-xl">
          ...
          <DropdownMenuItem onSelect={() => handleSelect('NVIDIA RTX 4080 Super')}>NVIDIA RTX 4080 Super</DropdownMenuItem>
          <DropdownMenuItem onSelect={() => handleSelect('NVIDIA RTX 4070 Ti Super')}>NVIDIA RTX 4070 Ti Super</DropdownMenuItem>
          ...
          <DropdownMenuItem onSelect={() => handleSelect('AMD Radeon RX 7800 XT')}>AMD Radeon RX 7800 XT</DropdownMenuItem>
